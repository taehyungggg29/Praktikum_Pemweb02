  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="kode" name="kode" type="text" class="form-control" value="<?= $result['kode'] ?>">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama" name="nama" type="text" class="form-control" value="<?= $result['nama'] ?>">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="harga_beli" name="harga_beli" value="<?= $result['harga_beli'] ?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="stok" name="stok" value="<?= $result['stok'] ?>"
